...
class Runner:
    ...
    def GetOutputPath(self, alg_name):
        ...
        # params
        self.params_str = str(self.k_value) + "k_" + str(len(self.qi_names)) + "q_"
        ...
        # alg_name + params
        self.output_file += alg_name + "_" + str(self.k_value) + "k_" + str(len(self.qi_names)) + "q_"
    ...
    def ReadConfig(self, alg_name):
        ...
        self.config['common']['table_path_base'] = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
        self.config['common']['output_path_base'] = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
    ...
    def WriteOutput(self, data):
        ...
        CsvWriter.WriteList(self.table_name + '_anon', data)